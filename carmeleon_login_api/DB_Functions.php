...
/**
    ...
    public function storeUser($password, $pin, $email, $username) {
        $hash = $this->hashSSHA($password);
        $encrypted_password = $hash["encrypted"]; // encrypted password
        $salt = $hash["salt"]; // salt
        $result = mysql_query("INSERT INTO users(username, email, password, pin, encrypted_password, salt, created_at) VALUES('$username', '$email', '$password', '$pin', '$encrypted_password', '$salt', NOW())");
