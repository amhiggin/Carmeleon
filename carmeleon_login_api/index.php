...
if (isset($_POST['tag']) && $_POST['tag'] != '') {
  ...
  $subject = "Change Password Notification";
         $message = "Hello User,nnYour Password is sucessfully changed.nn";
          $from = "contact@carmeleon.tk";
          $headers = "From:" . $from;
...
echo json_encode($response);
        ...
        if ($db->isUserExisted($email)) {
            ...
            // store user
            $user = $db->storeUser($password, $pin, $email, $username);
            if ($user) {
